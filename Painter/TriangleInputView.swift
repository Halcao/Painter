...
class TriangleInputView: UIView {
    ...
    private var textField6 = UITextField()
    ...
    private func setup() {
        ...
        textField6.snp.makeConstraints { make in
            make.top.equalTo(textField3.snp.bottom).offset(10)
        ...
        doneButton.snp.makeConstraints { make in
            ...
            make.top.equalTo(textField5.snp.bottom).offset(15)
...
extension TriangleInputView {
    @objc func done() {
        ...
        if verfiyTriangle(points: points) == false {
            SwiftMessages.showErrorMessage(body: "数据无法形成三角形，请重新输入")
            return
        }
